...
public class Plateau {
	...
	public boolean moveRobot(String s) {
	...
	public boolean robotinCible(Color col){
		boolean answer=false;
		switch (col) {
		case R:
			if(robotR!=null){
				if(robotR.equals(cible)){
					answer=true;
				}
			}
			break;
